...
class KafkaEventPublisher(EventPublisher):
    """
    Order Service Kafka publisher with connection retry logic
    """
    ...
    def _get_topic_for_event(self, event_type: str) -> str:
        ...
        topic_mapping = {
            ...
            "order.status_updated": "order.events",
            "order.cancelled": "order.events",
            "order.shipped": "order.events",
            "order.delivered": "order.events",
            "order.returned": "order.events",
            "order.refunded": "order.events",
        }
...
class KafkaEventSubscriber(EventSubscriber):
    """Order Service Kafka subscriber with connection retry logic"""
