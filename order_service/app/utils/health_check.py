"""
Order Service Health Check Utilities
====================================

Independent health check functionality for Order service.
...
class OrderServiceHealthChecker:
    """Order Service specific health checker"""

    def __init__(self, service_name: str = "order_service") -> None:
    ...
    def add_order_specific_checks(self) -> None:
        """Add Order Service specific health checks"""
                ...
                async with database_manager.async_session_maker() as session:
                    ...
                    return {
                        ...
                        "stats": {
                            ...
                            "pending_orders": stats[1] if stats else 0,
                            "processing_orders": stats[2] if stats else 0,
                            "delivered_orders": stats[3] if stats else 0,
                        },
                    }
            except Exception as e:
                return {
...
async def create_order_service_health_check_async(
    service_name: str = "order_service", version: str = "1.0.0"
) -> Dict[str, Any]:
    """Create comprehensive Order Service health check"""
    health_checker = OrderServiceHealthChecker(service_name)
    health_checker.add_order_specific_checks()
