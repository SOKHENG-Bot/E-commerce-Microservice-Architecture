"""
Notification Service Independent Logging Module
=============================================
...
def setup_notification_logging(
    ...
    """
    Setup independent logging for Notification Service
    ...
    # Log startup message
    logger.info(
        "Notification Service logging configured",
        extra={
...
default_notification_logger = None


def get_default_notification_logger() -> logging.Logger:
    """Get the default Notification Service logger instance"""
    global default_notification_logger
    if default_notification_logger is None:
        default_notification_logger = setup_notification_logging()
    return default_notification_logger
