...
log = ...
def create_ssl_context(*, cafile: Union[str, bytes, PathLike[str], PathLike[bytes], None] = ..., capath: Union[str, bytes, PathLike[str], PathLike[bytes], None] = ..., cadata: Union[str, Buffer, None] = ..., certfile: Union[str, bytes, PathLike[str], PathLike[bytes], None] = ..., keyfile: Union[str, bytes, PathLike[str], PathLike[bytes], None] = ..., password: Union[Callable[[], Union[str, bytes, bytearray]], str, bytes, bytearray, None] = ...) -> SSLContext:
    """
