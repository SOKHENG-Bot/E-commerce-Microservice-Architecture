...
from ._types import CodecGzipT, CodecLz4T, CodecMaskT, CodecNoneT, CodecSnappyT, CodecZstdT, DefaultCompressionTypeT, LegacyCompressionTypeT

class DefaultRecordBatchBuilderProtocol(Protocol):
    def __init__(self, magic: int, compression_type: DefaultCompressionTypeT, is_transactional: int, producer_id: int, producer_epoch: int, base_sequence: int, batch_size: int) -> None:
        ...
    
    def append(self, offset: int, timestamp: Optional[int], key: Optional[bytes], value: Optional[bytes], headers: list[tuple[str, Optional[bytes]]]) -> Optional[DefaultRecordMetadataProtocol]:
        ...
    ...
    def size_in_bytes(self, offset: int, timestamp: int, key: Optional[bytes], value: Optional[bytes], headers: list[tuple[str, Optional[bytes]]]) -> int:
        ...
    
    @classmethod
    def size_of(cls, key: Optional[bytes], value: Optional[bytes], headers: list[tuple[str, Optional[bytes]]]) -> int:
        ...
    
    @classmethod
    def estimate_size_in_bytes(cls, key: Optional[bytes], value: Optional[bytes], headers: list[tuple[str, Optional[bytes]]]) -> int:
        ...
...
class DefaultRecordProtocol(Protocol):
    def __init__(self, offset: int, timestamp: int, timestamp_type: int, key: Optional[bytes], value: Optional[bytes], headers: list[tuple[str, Optional[bytes]]]) -> None:
        ...
...
class LegacyRecordBatchBuilderProtocol(Protocol):
    ...
    def append(self, offset: int, timestamp: Optional[int], key: Optional[bytes], value: Optional[bytes], headers: Any = ...) -> Optional[LegacyRecordMetadataProtocol]:
        ...
    ...
    def size_in_bytes(self, offset: int, timestamp: int, key: Optional[bytes], value: Optional[bytes]) -> int:
...
class LegacyRecordProtocol(Protocol):
    def __init__(self, offset: int, timestamp: Optional[int], timestamp_type: Optional[Literal[0, 1]], key: Optional[bytes], value: Optional[bytes], crc: int) -> None:
        ...
...
class MemoryRecordsProtocol(Protocol):
    ...
    def next_batch(self) -> Optional[Union[DefaultRecordBatchProtocol, LegacyRecordBatchProtocol]]:
        ...
