...
from ._protocols import DefaultRecordBatchBuilderProtocol, DefaultRecordBatchProtocol, DefaultRecordMetadataProtocol, DefaultRecordProtocol
...
class _DefaultRecordBatchBuilderPy(DefaultRecordBase, DefaultRecordBatchBuilderProtocol):
    MAX_RECORD_OVERHEAD = ...
    def __init__(self, magic: int, compression_type: int, is_transactional: int, producer_id: int, producer_epoch: int, base_sequence: int, batch_size: int) -> None:
        ...
    
    def append(self, offset: int, timestamp: Optional[int], key: Optional[bytes], value: Optional[bytes], headers: list[tuple[str, Optional[bytes]]], encode_varint: Callable[[int, Callable[[int], None]], int] = ..., size_of_varint: Callable[[int], int] = ..., get_type: Callable[[Any], type] = ..., type_int: type[int] = ..., time_time: Callable[[], float] = ..., byte_like: tuple[type[bytes], type[bytearray], type[memoryview]] = ..., bytearray_type: type[bytearray] = ..., len_func: Callable[[Sized], int] = ..., zero_len_varint: int = ...) -> Optional[_DefaultRecordMetadataPy]:
