...
from aiokafka.record._protocols import LegacyRecordBatchBuilderProtocol, LegacyRecordBatchProtocol, LegacyRecordMetadataProtocol, LegacyRecordProtocol
...
class LegacyRecord(LegacyRecordProtocol):
    def __init__(self, offset: int, timestamp: int, attributes: int, key: bytes | None, value: bytes | None, crc: int) -> None:
        ...
...
class LegacyRecordBatchBuilder(LegacyRecordBatchBuilderProtocol):
    ...
    def append(self, offset: int, timestamp: int | None, key: bytes | None, value: bytes | None, headers: Any = ...) -> LegacyRecordMetadata:
        ...
