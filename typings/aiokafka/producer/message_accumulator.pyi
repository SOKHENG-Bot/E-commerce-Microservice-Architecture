...
class BatchBuilder:
    def __init__(self, magic, batch_size, compression_type, *, is_transactional, key_serializer=..., value_serializer=...) -> None:
        ...
    
    def append(self, *, timestamp, key, value, headers: Sequence = ...): # -> DefaultRecordMetadataProtocol | LegacyRecordMetadataProtocol | None:
