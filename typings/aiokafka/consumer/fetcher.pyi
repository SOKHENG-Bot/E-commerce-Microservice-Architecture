...
class PartitionRecords:
    def __init__(self, tp, records, aborted_transactions, fetch_offset, key_deserializer, value_deserializer, check_crcs, isolation_level) -> None:
        ...
...
class Fetcher:
    ...
    """
    def __init__(self, client, subscriptions, *, key_deserializer=..., value_deserializer=..., fetch_min_bytes=..., fetch_max_bytes=..., fetch_max_wait_ms=..., max_partition_fetch_bytes=..., check_crcs=..., fetcher_timeout=..., prefetch_backoff=..., retry_backoff_ms=..., auto_offset_reset=..., isolation_level=...) -> None:
        ...
