...
class GroupCoordinator(BaseCoordinator):
    ...
    """
    def __init__(self, client, subscription, *, group_id=..., group_instance_id=..., session_timeout_ms=..., heartbeat_interval_ms=..., retry_backoff_ms=..., enable_auto_commit=..., auto_commit_interval_ms=..., assignors=..., exclude_internal_topics=..., max_poll_interval_ms=..., rebalance_timeout_ms=...) -> None:
...
class CoordinatorGroupRebalance:
    ...
    """
    def __init__(self, coordinator, group_id, coordinator_id, subscription, assignors, session_timeout_ms, retry_backoff_ms) -> None:
        ...
