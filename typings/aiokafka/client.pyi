...
class AIOKafkaClient:
    ...
    """
    def __init__(self, *, loop=..., bootstrap_servers=..., client_id=..., metadata_max_age_ms=..., request_timeout_ms=..., retry_backoff_ms=..., ssl_context=..., security_protocol=..., api_version=..., connections_max_idle_ms=..., sasl_mechanism=..., sasl_plain_username=..., sasl_plain_password=..., sasl_kerberos_service_name=..., sasl_kerberos_domain_name=..., sasl_oauth_token_provider=...) -> None:
        ...
    ...
    async def check_version(self, node_id=...): # -> tuple[Literal[0], Literal[10], Literal[0]]:
