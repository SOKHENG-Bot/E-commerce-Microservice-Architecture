...
async def create_conn(host, port, *, client_id=..., request_timeout_ms=..., api_version=..., ssl_context=..., security_protocol=..., max_idle_ms=..., on_close=..., sasl_mechanism=..., sasl_plain_username=..., sasl_plain_password=..., sasl_kerberos_service_name=..., sasl_kerberos_domain_name=..., sasl_oauth_token_provider=..., version_hint=...): # -> AIOKafkaConnection:
    ...
...
class AIOKafkaConnection:
    ...
    _reader = ...
    _source_traceback = ...
    def __init__(self, host, port, *, client_id=..., request_timeout_ms=..., api_version=..., ssl_context=..., security_protocol=..., max_idle_ms=..., on_close=..., sasl_mechanism=..., sasl_plain_password=..., sasl_plain_username=..., sasl_kerberos_service_name=..., sasl_kerberos_domain_name=..., sasl_oauth_token_provider=..., version_hint=...) -> None:
        ...
    ...
    def send(self, request, expect_response=...): # -> CoroutineType[Any, Any, None] | CoroutineType[Any, Any, Any]:
        ...
...
class SaslGSSAPIAuthenticator(BaseSaslAuthenticator):
    ...
    def authenticator_gssapi(self): # -> Generator[tuple[Any | Literal[b""], Literal[True]] | tuple[Any, Literal[False]], Any, None]:
        ...
