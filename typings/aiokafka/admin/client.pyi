...
class AIOKafkaAdminClient:
    ...
    """
    def __init__(self, *, loop=..., bootstrap_servers: Union[str, list[str]] = ..., client_id: str = ..., request_timeout_ms: int = ..., connections_max_idle_ms: int = ..., retry_backoff_ms: int = ..., metadata_max_age_ms: int = ..., security_protocol: str = ..., ssl_context: Optional[SSLContext] = ..., api_version: str = ..., sasl_mechanism: str = ..., sasl_plain_username: Optional[str] = ..., sasl_plain_password: Optional[str] = ..., sasl_kerberos_service_name: str = ..., sasl_kerberos_domain_name: Optional[str] = ..., sasl_oauth_token_provider: Optional[str] = ...) -> None:
        ...
    ...
    async def create_topics(self, new_topics: list[NewTopic], timeout_ms: Optional[int] = ..., validate_only: bool = ...) -> Response:
    ...
    async def delete_topics(self, topics: list[str], timeout_ms: Optional[int] = ...) -> Response:
    ...
    async def describe_topics(self, topics: Optional[list[str]] = ...) -> list[Any]:
        ...
    
    async def describe_cluster(self) -> dict[str, Any]:
        ...
    
    async def describe_configs(self, config_resources: list[ConfigResource], include_synonyms: bool = ...) -> list[Response]:
    ...
    async def create_partitions(self, topic_partitions: dict[str, NewPartitions], timeout_ms: Optional[int] = ..., validate_only: bool = ...) -> Response:
    ...
    async def describe_consumer_groups(self, group_ids: list[str], group_coordinator_id: Optional[int] = ..., include_authorized_operations: bool = ...) -> list[Response]:
    ...
    async def list_consumer_groups(self, broker_ids: Optional[list[int]] = ...) -> list[tuple[Any, ...]]:
    ...
    async def list_consumer_group_offsets(self, group_id: str, group_coordinator_id: Optional[int] = ..., partitions: Optional[list[TopicPartition]] = ...) -> dict[TopicPartition, OffsetAndMetadata]:
    ...
    async def delete_records(self, records_to_delete: dict[TopicPartition, RecordsToDelete], timeout_ms: Optional[int] = ...) -> dict[TopicPartition, int]:
