"""
Role-based authorization middleware for User Service.
...
try:
    ...
    logger = logging.getLogger("user_service_roles")
...
def setup_user_role_authorization_middleware(
    ...
    """
    Setup role-based authorization middleware for User Service.
    ...
    Example role_requirements:
    {
        ...
        "/api/v1/permissions": ["admin", "moderator"],  # Admin or moderator
        "/user-service": "admin",  # Management routes
    }
    """
    ...
    if role_requirements is None:
        # Default role requirements for user service patterns
        role_requirements = {
            "/api/v1/users": [
                "admin",
                "moderator",
            ],  # User management requires admin/moderator
            "/api/v1/permissions": "admin",  # Permission management requires admin
            "/user-service": "admin",  # Management routes require admin
            "/api/v1/bulk": [
                "admin",
                "moderator",
