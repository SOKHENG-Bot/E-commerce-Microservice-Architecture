...
try:
    ...
    logger = setup_product_logging("product_service_auth")
except ImportError:
    logger = logging.getLogger("product_service_auth")
...
class ProductServiceAuthMiddleware(BaseHTTPMiddleware):
    """
    Authentication middleware for Product Service.
    ...
    async def _authenticate_request(self, request: Request) -> Dict[str, Any]:
        ...
        try:
            ...
            # Validate token (placeholder - integrate with your auth service)
    ...
    async def _validate_token(self, token: str) -> Optional[Dict[str, Any]]:
        ...
        """
        try:
            # Import JWT handler and settings
            from app.core.setting import get_settings
            from app.utils.jwt_handler import JWTHandler

            # Get JWT settings from centralized configuration
...
def setup_product_auth_middleware(
    app: FastAPI, exclude_paths: Optional[list[str]] = None
) -> None:
    """
    Setup authentication middleware for Product Service.
    ...
    app.add_middleware(ProductServiceAuthMiddleware, exclude_paths=exclude_paths)

    logger.info(
        "Product Service authentication middleware configured",
        extra={
            "service": "product_service",
