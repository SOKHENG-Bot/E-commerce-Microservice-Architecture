"""
Request/Response validation middleware for Product Service.
...
try:
    ...
    logger = setup_product_logging("product_service_validation")
except ImportError:
    logger = logging.getLogger("product_service_validation")
...
class RequestValidationMiddleware(BaseHTTPMiddleware):
    """
    Comprehensive request validation middleware for Product Service.
        ...
        try:
            ...
            if content_length:
                ...
                if size > self.max_request_size:
                    return {
                        "valid": False,
                        "error": f"Request size {size} exceeds maximum allowed {self.max_request_size}",
                    }
            ...
            if request.method in ["POST", "PUT", "PATCH"]:
                ...
                if len(body) > self.max_request_size:
                    return {
                        "valid": False,
                        "error": f"Request body size {len(body)} exceeds maximum allowed {self.max_request_size}",
                    }
    ...
    async def _validate_request_body(self, request: Request) -> Dict[str, Any]:
        ...
        try:
            ...
            validation_result = self._validate_json_security(data)
...
def setup_request_validation_middleware(
    app: FastAPI,
    ...
    """
    Setup request validation middleware for Product Service.
